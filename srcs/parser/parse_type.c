...
t_parse_type	*get_parse_funs(void)
{
	static t_parse_type	parse_type[] = {
		...
		ADD_TYPE(pos, 3, "2 3 4 5 10 15 16"),
		ADD_TYPE(dir, 3, "2 3 4 5  10 17"),
		ADD_TYPE(radius, 1, "2 3 4 5 10"),
		ADD_TYPE(color, 3, "2 3 4 5 10"),
		ADD_TYPE(intensity, 3, "14 15 16 17"),
		ADD_TYPE(phong, 3, "2 3 4 5 10"),
		ADD_TYPE(angle, 1, ""),
		ADD_TYPE(size, 1, ""),
		ADD_TYPE(reflexion, 1, "2 3 4 5 10"),
